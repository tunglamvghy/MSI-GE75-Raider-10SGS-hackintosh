DefinitionBlock ("", "SSDT", 2, "HACK", "PCI", 0x00000000)
{
	...
	Device (_SB.PCI0.IGPU)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				...
				"model", Buffer () { "Intel UHD Graphics" },
	...
	External (_SB_.PCI0.LT98, DeviceObj)
	Device (_SB.PCI0.LT98)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Comet Lake PCH Thermal Controller" },
	...
	Device (_SB.PCI0.I2C2)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Comet Lake PCH Serial IO I2C Controller #2" },
				"device_type", Buffer () { "Serial bus controller" },
	...
	External (_SB_.PCI0.PEG0.NXHC, DeviceObj)
	Device (_SB.PCI0.PEG0.NXHC)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "TU104 USB 3.1 Host Controller" },
				"device_type", Buffer () { "USB controller" },
				"AAPL,slot-name", Buffer () { "Internal@0,1,0/0,2" },
			})
		}
	}
	...
	Device (_SB.PCI0.LPCB)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Comet Lake LPC Controller" },
	...
	Device (_SB.PCI0.XSPI)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Comet Lake PCH SPI Controller" },
				"device_type", Buffer () { "Serial bus controller" },
	...
	Device (_SB.PCI0.RP15.PXSX)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Killer E2500 Gigabit Ethernet Controller" },
